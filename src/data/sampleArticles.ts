...
Automotive partners plan pilot manufacturing line tests later this year, projecting that long-distance electric vehicles could achieve over 600 miles on a single charge and recharge from 10% to 80% in just under ten minutes under standard highway chargers. Analysts suggest this could remove the primary barrier for mass fleet electrification and heavy-duty logistics.`
  },
  {
    id: 'sample-2',
...
Transit planners highlighted integrated station design featuring solar canopies, micromobility hubs, and touchless biometric boarding. Initial ridership exceeded opening-day projections, with transportation officials forecasting a reduction of roughly 14,000 daily automotive commuter trips along the parallel interstate corridor.`
  },
  {
    ...
    content: `Spectroscopic observations captured by the latest generation space telescope have revealed unambiguous signatures of water vapor, carbon dioxide, and ozone in the upper atmosphere of a rocky exoplanet orbiting a quiet red dwarf star thirty-four light-years away.
